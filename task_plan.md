...
4. [in progress] Local regression and visual checks complete; documentation ready; publish final commits, verify GitHub CI, merge main and verify remote hashes.
