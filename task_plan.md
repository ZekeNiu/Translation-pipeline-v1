...
2. [in progress] Official MinerU upload/poll/resume; structure-aware PDF parts, conservative seam repair and asset-safe merge.
3. [pending] Structure-first translation, in-place references, validated caches, resumable tasks and selective retries.
